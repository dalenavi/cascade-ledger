...
final class Job {
    ...
    var parametersJSON: Data?         // Type-specific input params (includes IDs for relationships)
    ...
    init(id: UUID = UUID(), type: JobType, title: String, tags: [String] = []) {
        self.id = id
        self.type = type
        self.status = .pending
        self.title = title
